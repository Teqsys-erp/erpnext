...
erpnext.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
        ...
        $btn_start.click(function (e) {
                if (!initialized) {
                        ...
                        row.completed = 0;
                        row.custom_timer_status = "Running";
                        frm.set_value("custom_timer_status", "Running");
                        frm.script_manager.trigger("activity_type", row.doctype, row.name);
        ...
        $btn_complete.click(function () {
                ...
                grid_row.doc.custom_timer_status = "Completed";
                frm.set_value("custom_timer_status", "Completed");
